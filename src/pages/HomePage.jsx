				...
				<div className="left-blog">
					<div className="blog-list">
						{blogData.map((blog, index) => {
							return <Link key={index} to={`blog/1`} className="blog-item">
								<div>
									<div className="image">
										<img src={'https://754969b0.rocketcdn.me/blonwe/grocery/wp-content/uploads/sites/5/2023/03/post-04.jpg'} alt="image01" />
									</div>
									<div className="content">
